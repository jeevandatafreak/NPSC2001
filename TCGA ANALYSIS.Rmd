...
clinical_data %>% ggplot(aes(x = ER.Status, y = Age.at.Initial.Pathologic.Diagnosis, colour = ER.Status)) +
  geom_boxplot() +
  labs(x = "Estrogen Status", y = "Diagnosis Age", title = "Boxplot of Estrogen by Diagnosis Age") 
...
```{r}
ggplot(data = clinical_data, aes(x=PAM50.mRNA, fill = AJCC.Stage)) + geom_bar(alpha = 0.9) + labs (x="Breast Cancer Types (PAM50 classification)", y = "Total", title = "Breast Cancer Subtypes")  
